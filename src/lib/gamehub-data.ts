...
> = {
  soccer: 2 * 60 * 60 * 1000,
  "american-football": 3.5 * 60 * 60 * 1000,
  football: 3.5 * 60 * 60 * 1000,
  basketball: 2.5 * 60 * 60 * 1000,
  "ice-hockey": 2.5 * 60 * 60 * 1000,
  baseball: 3.5 * 60 * 60 * 1000,
  softball: 2 * 60 * 60 * 1000,
  volleyball: 2 * 60 * 60 * 1000,
  "field-hockey": 1 * 60 * 60 * 1000,
  "rugby-union": 2 * 60 * 60 * 1000,
  "rugby-league": 2 * 60 * 60 * 1000,
  afl: 3 * 60 * 60 * 1000,
  lacrosse: 1 * 60 * 60 * 1000,
  "water-polo": 1 * 60 * 60 * 1000,
  handball: 1 * 60 * 60 * 1000,
  tennis: 3 * 60 * 60 * 1000,
  "table-tennis": 1 * 60 * 60 * 1000,
  pickleball: 1 * 60 * 60 * 1000,
  cricket: 7 * 60 * 60 * 1000,
  motorsport: 3 * 60 * 60 * 1000,
  golf: 6 * 60 * 60 * 1000,
  boxing: 6 * 60 * 60 * 1000,
  mma: 6 * 60 * 60 * 1000,
  "bare-knuckle-fighting": 4 * 60 * 60 * 1000,
  grappling: 4 * 60 * 60 * 1000,
  wrestling: 2 * 60 * 60 * 1000,
  darts: 4 * 60 * 60 * 1000,
  "bull-riding": 2 * 60 * 60 * 1000,
  cycling: 6 * 60 * 60 * 1000,
  triathlon: 4 * 60 * 60 * 1000,
  marathon: 4 * 60 * 60 * 1000,
  "road-running": 4 * 60 * 60 * 1000,
  surfing: 3 * 60 * 60 * 1000,
  "track-and-field": 5 * 60 * 60 * 1000,
  swimming: 5 * 60 * 60 * 1000,
  "swimming-diving": 5 * 60 * 60 * 1000,
};
